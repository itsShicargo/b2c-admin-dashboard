...
import { Input, Button, Select, FormItem, FormContainer, Alert } from 'components/ui';
...
const validationSchema = Yup.object().shape({
    to_warehouse: Yup.string().required('Please select the pincode zone'),
    receiver_contact_person_name: Yup.string().required('Contact Person Name is required'),
    receiver_contact_person_contact_no: Yup.string().matches(/^\d{10}$/, 'Contact Person Number must be 10 digits').required('Contact Person Number is required'),
...
const DestinationWarehouse = ({
    ...
    const createPayload = (values) => {
        ...
        to_warehouse === 2 ? {} : warehouseData[to_warehouse]
                        ...
                        <FormContainer>
                            ...
                            <div className="md:grid grid-cols-3 gap-4">
                                ...
                                <FormItem
                                    ...
                                    invalid={
                                        errors.receiver_contact_person_contact_no &&
                                        touched.receiver_contact_person_contact_no
                                    }
